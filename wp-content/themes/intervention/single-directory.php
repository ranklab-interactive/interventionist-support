                    ...
                    <div class="inside">
                        <div class="text-block">
                                ...
                                <div class="headshot">
                                    <?php
                                        ...
                                        if ( has_post_thumbnail() ) {
                                                the_post_thumbnail( array(129,129, 'itemprop' => 'image'));
                                        }
                                    ?>
                                </div>
                                <div class="info-block-online-contact">
                            ...
                            <?php if(get_post_meta($post->ID,'frothy_website_url', true)) echo '<div class="website-container"><a href="'.get_post_meta($post->ID,'frothy_website_url', true).'" target="_blank" itemprop="url">'.get_post_meta($post->ID,'frothy_website_url', true) .'</a></div>';?>
                                ...
                                <div class="interventionist-additional-info">
                            ...
                            ?>
                                <!--TODO Add conditional for  fields otherwise it adds an empty <p></p>-->
                <?php if (get_post_meta($post->ID,'frothy_interventionist_phone', true)) echo '<p><span itemprop="telephone">'.do_shortcode('[frn_phone number="'.get_post_meta($post->ID,'frothy_interventionist_phone', true).'" ga_phone_location="Phone Clicks on Page (Interventionist)" ga_phone_label="include_phone"]'); echo '</span></p>'?>
                                    </div>
                                    <div>
                                        <h4>States</h4>
                                        <div class="address" itemprop="address" itemscope itemtype="http://schema.org/PostalAddress">
                                            <p class="interventionist-states">
                                <?php 
...
<?php if(get_post_meta($post->ID,'frothy_support_autobiography', true)) echo '<h3>In My Words</h3><p>'.get_post_meta($post->ID,'frothy_support_autobiography', true).'</p>'; ?>                                
            ...
            <aside>
                <h2>Get Help Choosing an Interventionist</h2>	
                ...
                ?>
                        ...
                        else echo "<p>Our team of experts will help guide which qualified interventionist can help with your situation.</p>";
